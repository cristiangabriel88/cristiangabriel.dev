...
function Ico({
  ...
  if (name === 'github') return React.createElement('svg', common, React.createElement('path', {
  ...
  if (name === 'linkedin') return React.createElement('svg', common, React.createElement('path', {
  ...
  if (name === 'stack') return React.createElement('svg', common, React.createElement('path', {
    d: 'M3 12h14M3 16h14M3 8l13 2M5 4l11 4M17 18v3H3v-3'
  }));
  if (name === 'pin') return React.createElement('svg', common, React.createElement('path', {
  ...
  if (name === 'mail') return React.createElement('svg', common, React.createElement('path', {
...
function Sidebar({
  ...
  React.createElement('circle', {
    ...
    className: 'social-label'
  }, 'Stack Overflow')), React.createElement('a', {
    className: 'social',
    ...
    className: 'social-label'
  }, 'Bucharest, RO')), React.createElement('a', {
    className: 'social',
...
function BotanicalAnchor({
  ...
  return React.createElement('img', {
    key: page,
    // force reload+fade on page change
