...
function HomePage({ onNav, tweaks, paused = false }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      "I’m ",
      React.createElement("em", null, "Cristian"),
      ".",
    ),
    React.createElement(
      "p",
    ...
    React.createElement(
      ...
      React.createElement(
        "button",
        { className: "btn", onClick: () => onNav("projects") },
        "View projects",
        React.createElement("span", { className: "arrow" }, "→"),
      ),
      React.createElement(
        "button",
        { className: "btn ghost", onClick: () => onNav("about") },
        "About me",
      ),
    ),
...
function AboutPage({ tweaks }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("em", null, "refining"),
          ".",
        ),
      ),
      React.createElement(
    ...
    React.createElement(
      "div",
      { className: "about-body", style: { marginTop: 28 } },
      React.createElement(
        "p",
        null,
      ...
      React.createElement(
        ...
        React.createElement("strong", null, "Java"),
        " and ",
        React.createElement("strong", null, "Spring Boot"),
        ", building server-side applications using ",
        React.createElement("strong", null, "Thymeleaf"),
        " and working with relational databases through ",
        React.createElement("strong", null, "SQL"),
        ", ",
        React.createElement("strong", null, "PostgreSQL"),
        ", and ",
        React.createElement("strong", null, "MySQL"),
        ". My work involves implementing application logic, handling data from the database, and generating documents such as ",
      ...
      React.createElement(
        ...
        ", use ",
        React.createElement("strong", null, "Git"),
        " and ",
    ...
    React.createElement(
      "div",
      { id: "tech-stack", className: "section-label" },
      React.createElement(
        "h3",
        null,
        "Tech ",
        React.createElement("em", null, "stack"),
      ),
    ),
    React.createElement(
      "div",
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        null,
        "A short ",
        React.createElement("em", null, "timeline"),
      ),
    ),
    React.createElement(
      "div",
      ...
      timeline.map((t) => {
        ...
        return React.createElement(
          "div",
          { key: t.year, className: "timeline-row" },
          yearEl,
          React.createElement(
            "div",
...
function ProjectsPage({ tweaks }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      null,
      "Things I’ve ",
      React.createElement("em", null, "made"),
      ".",
    ),
    React.createElement(
      "p",
    ...
    project.thumb
      ? React.createElement(
          ...
          React.createElement("img", {
            ...
            alt: project.name,
            decoding: "async",
            style: project.thumbFit ? { objectFit: project.thumbFit } : undefined,
          }),
        )
      : React.createElement(
          "div",
