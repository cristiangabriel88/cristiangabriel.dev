    ...
    return (
      <React.Fragment>
        ...
        <main className="page">
          ...
          <div className="page-slot" hidden={page !== "about"}>
            <AboutPage tweaks={t} />
          </div>
          <div className="page-slot" hidden={page !== "projects"}>
            <ProjectsPage tweaks={t} />
          </div>
          <PageFooter page={page} />
        </main>
        {
          // ###### EASTER EGGS ######
          t.showLeafParticles && <LeafParticles enabled={true} />
        }
        {
          ...
          t.showIdleGarden && (
            <IdleGarden enabled={true} paused={termOpen || tweaksOpen} />
          )
        }
        <Terminal
          open={termOpen}
        ...
        <TweaksPanel title="Tweaks">
          ...
          />
          <TweakSection label="Pixel layer" />
          <TweakToggle
