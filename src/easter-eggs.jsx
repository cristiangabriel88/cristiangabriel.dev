  ...
  function Terminal({ open, onClose, autoLaunchGame = false }) {
    ...
    function forestMenuLines(F) {
      ...
      const out = [
        ...
        { text: "", kind: "game" },
        { text: "  1) new game", kind: "choice" },
      ];
      if (hasSave) out.push({ text: "  2) resume your walk", kind: "choice" });
      out.push({ text: "  3) endings & achievements", kind: "choice" });
      out.push({ text: "  4) how to play", kind: "choice" });
      out.push({ text: "  5) new game with a seed", kind: "choice" });
    ...
    function onSubmit(e) {
      ...
      if (gameMode === "forest-seed") {
        ...
        startForestGame(F, isNaN(n) ? {} : { seed: n });
        return;
      }
