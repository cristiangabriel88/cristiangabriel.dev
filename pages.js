...
function HomePage({
  ...
  return React.createElement('section', {
    ...
    className: 'rule'
  }), React.createElement('span', null, 'PORTFOLIO · 2026')), React.createElement('h1', null, 'Hey there, ', React.createElement('br'), 'I’m ', React.createElement('em', null, 'Cristian'), '.'), React.createElement('p', {
    className: 'tagline'
  },
  ...
  }, 'A software engineer based in Bucharest, building server-side applications and personal side-quests outside of client work. This is my own little plot of the internet. Quiet, green, occasionally pixelated.'), React.createElement('div', {
    className: 'cta-row'
  }, React.createElement('button', {
    className: 'btn',
    onClick: () => onNav('projects')
  }, 'View projects', React.createElement('span', {
    className: 'arrow'
  }, '→')), React.createElement('button', {
    className: 'btn ghost',
    onClick: () => onNav('about')
  ...
  // pixel divider
  tweaks.showPixelArt && React.createElement(PixelDivider, {
    width: 460
  }),
  // hero-meta strip
  React.createElement('div', {
    className: 'hero-meta'
  }, React.createElement('div', null, 'Based in', React.createElement('strong', null, 'Bucharest, Romania')), React.createElement('div', {
    className: 'meta-link',
    role: 'button',
    tabIndex: 0,
    onClick: goToStack,
  ...
  }, 'Stack', React.createElement('strong', null, 'Java · Spring Boot · SQL')), React.createElement('div', null, 'Status', React.createElement('strong', null, React.createElement('span', {
...
function AboutPage({
  ...
  return React.createElement('section', {
  ...
  }, React.createElement('h1', null, 'Full stack developer,', React.createElement('br'), 'always improving and ', React.createElement('em', null, 'refining'), '.')), React.createElement('div', {
  ...
  }, React.createElement('p', null, 'My name is Cristian Gabriel. I’m a software engineer focused on building practical, well-structured solutions, with a strong foundation in ', React.createElement('strong', null, 'HTML'), ', ', React.createElement('strong', null, 'CSS'), ', ', React.createElement('strong', null, 'JavaScript'), ', and ', React.createElement('strong', null, 'Bootstrap'), '.'), React.createElement('p', null, 'This website is a personal portfolio showcasing my private passion projects, built independently outside of client or commercial work. I primarily work with ', React.createElement('strong', null, 'Java'), ' and ', React.createElement('strong', null, 'Spring Boot'), ', building server-side applications using ', React.createElement('strong', null, 'Thymeleaf'), ' and working with relational databases through ', React.createElement('strong', null, 'SQL'), ', ', React.createElement('strong', null, 'PostgreSQL'), ', and ', React.createElement('strong', null, 'MySQL'), '. My work involves implementing application logic, handling data from the database, and generating documents such as ', React.createElement('strong', null, 'PDF reports'), '.'), React.createElement('p', null, 'I develop mainly on ', React.createElement('strong', null, 'Linux-based systems'), ', use ', React.createElement('strong', null, 'Git'), ' and ', React.createElement('strong', null, 'GitHub'), ' for version control, and follow clean, maintainable development practices. I also use ', React.createElement('strong', null, 'LLM prompting'), ' as a practical tool to support development and analysis tasks.')), tweaks.showPixelArt && React.createElement(PixelDivider, {
    width: 480
  }), React.createElement('div', {
    id: 'tech-stack',
    className: 'section-label'
  }, React.createElement('h3', null, 'Tech ', React.createElement('em', null, 'stack'))), React.createElement('div', {
    className: 'tech-grid'
  }, techStack.map(name => React.createElement('div', {
    key: name,
    className: 'tech-cell'
  }, tweaks.showPixelArt ? React.createElement(PixelIcon, {
    name,
    scale: 2
  }) : React.createElement('div', {
    style: {
    ...
    className: 'section-label'
  }, React.createElement('h3', null, 'A short ', React.createElement('em', null, 'timeline'))), React.createElement('div', {
    className: 'timeline'
  }, timeline.map(t => {
    const yearEl = t.year === '2023' ? React.createElement('a', {
    ...
    }, yearEl, React.createElement('div', {
      className: 'timeline-body'
    }, React.createElement('strong', null, t.title), React.createElement('span', null, t.body)));
  })));
}
...
function ProjectsPage({
  ...
  return React.createElement('section', {
    ...
    className: 'about-kicker'
  }, 'Projects'), React.createElement('h1', null, 'Things I’ve ', React.createElement('em', null, 'made'), '.'), React.createElement('p', {
    className: 'projects-intro'
  }, 'A handful of personal projects, built outside of client work, for the joy of it. Each one was a chance to learn something specific, ship something real, and overengineer a little.'), tweaks.showPixelArt && React.createElement(PixelDivider, {
    width: 520
  }), React.createElement('div', {
...
function ProjectCard({
  ...
  }, project.thumb ? React.createElement('div', {
  ...
  }, project.thumbLabel), React.createElement('div', {
    className: 'project-body'
  }, React.createElement('div', {
    className: 'project-tag'
  }, `0${index + 1} · Personal Project`), React.createElement('div', {
    className: 'project-name'
  }, project.name.split(' ').map((w, i) => i === 0 ? React.createElement(React.Fragment, {
    key: i
  }, w, ' ') : React.createElement('em', {
    key: i
  }, w + ' '))), React.createElement('div', {
    className: 'project-desc'
  }, project.tagline), React.createElement('div', {
    className: 'project-tech'
  }, project.tech.map(t => React.createElement('span', {
    key: t
  }, t))), project.url && React.createElement('div', {
    className: 'project-cta'
  }, project.cta, React.createElement('span', {
    className: 'arrow'
  }, '→'))));
}
