(function () {
  ...
  function LeafParticles({
    ...
    useEffect(() => {
      ...
      tmpl.innerHTML = '<svg viewBox="0 0 16 16" width="100%" height="100%">' + '<path d="M8 1 C 13 4, 14 10, 8 15 C 2 10, 3 4, 8 1 Z" opacity="0.85"/>' + '<path d="M8 1 L 8 15" stroke-width="0.8"/>' + "</svg>";
  ...
  function PixelCharacter({
    ...
    }, /*#__PURE__*/React.createElement(PixelGrid, {
  ...
  function makePlant() {
    ...
    const {
      topX,
      topY
    } = addStem(rfloat(-H * 0.16, H * 0.16), H);
    if (variety === "fern") {
  ...
  function PlantSVG({
    ...
    const children = spec.parts.map((p, i) => p.tag === "circle" ? /*#__PURE__*/React.createElement("circle", {
      key: i,
      cx: p.cx,
      cy: p.cy,
      r: p.r,
  ...
  function IdleGarden({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      "aria-hidden": "true"
    }, plants.map((p, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
    ...
    }, /*#__PURE__*/React.createElement(PlantSVG, {
      spec: p.spec
    }))))));
  }
  ...
  const TERMINAL_BANNER = [" ___  ___  _ _ ", "|  _|/ __|| | |", "| |_ \\__ \\| | |", "|___||___/|_|_|", "", "┌── cg.term v1.0  ────────────────────────────────────────", "│  type `help` for commands. `exit` or Esc to close.", "└──────────────────────────────────────────────────────────", ""];
  ...
  function Terminal({
    ...
    function revealOnElement(el, text, lineIdx, onDone) {
      ...
      function finalize() {
        ...
        setHistory(h => h.map((l, i2) => i2 === lineIdx ? {
          ...l,
          text,
          isTyping: false,
          fullText: undefined
        ...
        if (next) revealOnElement(next.el, next.text, next.lineIdx, next.onDone);else if (onDone) onDone();
      }
    ...
    useEffect(() => {
      if (open) {
        ...
        setHistory(TERMINAL_BANNER.map(l => ({
          kind: "ok",
          text: l
        })));
        clearInput();
    ...
    if (minimized) {
      return /*#__PURE__*/React.createElement("button", {
        ...
        className: "mp-dot"
      })), /*#__PURE__*/React.createElement("span", null, "cg.term \u2191"));
    }
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "title"
    }, "cg@portfolio ~ %"), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 56
      }
    })), gameOpen ? /*#__PURE__*/React.createElement(MiniGame, {
      onExit: () => {
    ...
    }, history.map((line, i) => /*#__PURE__*/React.createElement("p", {
      key: i,
      className: line.kind + (line.isTyping ? " typing" : ""),
      ref: line.isTyping ? el => {
  ...
  function MiniGame({
    ...
    function draw() {
      ...
      for (let i = snake.length - 1; i >= 0; i--) {
        ...
        const paint = (px, py) => {
          if (i === 0) drawHead(ctx, px, py, lastAppliedDirRef.current);else drawBody(ctx, px, py);
        };
        paint(cx, cy);
        // Split-draw across wrapped edges so the segment is visible on both sides during the slide.
        if (cx < 0) paint(cx + COLS * PX, cy);else if (cx > (COLS - 1) * PX) paint(cx - COLS * PX, cy);
        if (cy < 0) paint(cx, cy + ROWS * PX);else if (cy > (ROWS - 1) * PX) paint(cx, cy - ROWS * PX);
      }
    }
    function begin() {
    ...
    useEffect(() => {
      function onKey(e) {
        ...
        if (e.key === "ArrowUp" || k === "w") next = {
          dx: 0,
          dy: -1
        };else if (e.key === "ArrowDown" || k === "s") next = {
          dx: 0,
          dy: 1
        };else if (e.key === "ArrowLeft" || k === "a") next = {
          dx: -1,
          dy: 0
        };else if (e.key === "ArrowRight" || k === "d") next = {
          dx: 1,
          dy: 0
        };
        if (!next) return;
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "mini-game snake"
    }, /*#__PURE__*/React.createElement("div", {
      className: "mg-hud"
    }, /*#__PURE__*/React.createElement("span", null, "SCORE: ", score), /*#__PURE__*/React.createElement("span", null, "LEN: ", length), /*#__PURE__*/React.createElement("span", {
      style: {
        cursor: "pointer"
      },
      onClick: onExit
    }, "[esc] exit")), /*#__PURE__*/React.createElement("div", {
    ...
    }, over ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h4", null, "GAME OVER"), /*#__PURE__*/React.createElement("p", null, `Score: ${score}. Length: ${length}.`), /*#__PURE__*/React.createElement("button", {
      className: "mg-btn",
      onClick: begin
    ...
    }, "back to terminal")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h4", null, "SNAKE"), /*#__PURE__*/React.createElement("p", null, "Arrows or WASD to steer. Walls wrap. Eat the fruit. Don't bite yourself."), /*#__PURE__*/React.createElement("button", {
      className: "mg-btn",
      onClick: begin
    }, "start"))));
  }
