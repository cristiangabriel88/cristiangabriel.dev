...
function Terminal({
  ...
  React.createElement('button', {
    ...
    className: 'title'
  }, 'cg@portfolio ~ %'), React.createElement('div', {
    style: {
      width: 56
    }
  })), gameOpen ? React.createElement(MiniGame, {
    onExit: () => {
  ...
  }, history.map((line, i) => React.createElement('p', {
    key: i,
  ...
  }, line.text))), React.createElement('form', {
...
function MiniGame({
  ...
  return React.createElement('div', {
    ...
    className: 'mg-hud'
  }, React.createElement('span', null, 'SCORE: ', score), React.createElement('span', null, 'LEN: ', length), React.createElement('span', {
    style: {
      cursor: 'pointer'
    },
    onClick: onExit
  }, '[esc] exit')), React.createElement('div', {
  ...
  }, over ? React.createElement(React.Fragment, null, React.createElement('h4', null, 'GAME OVER'), React.createElement('p', null, `Score: ${score}. Length: ${length}.`), React.createElement('button', {
    className: 'mg-btn',
    onClick: begin
  ...
  }, 'back to terminal')) : React.createElement(React.Fragment, null, React.createElement('h4', null, 'SNAKE'), React.createElement('p', null, 'Arrows or WASD to steer. Walls wrap. Eat the fruit. Don\'t bite yourself.'), React.createElement('button', {
    className: 'mg-btn',
    onClick: begin
  }, 'start'))));
}
